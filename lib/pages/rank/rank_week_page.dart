...
/// 分类列表
class RankWeekPage extends StatefulWidget {
  final String type;
  RankWeekPage({Key key, this.type}) : super(key: key);

  @override
  State<StatefulWidget> createState() => RankWeekPageState();
}

class RankWeekPageState extends State<RankWeekPage> {
