...
/// 分类列表
class RankDayPage extends StatefulWidget {
  final String type;
  RankDayPage({Key key, this.type}) : super(key: key);

  @override
  State<StatefulWidget> createState() => RankDayPageState();
}

class RankDayPageState extends State<RankDayPage> {
