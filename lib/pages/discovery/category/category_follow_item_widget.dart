...
/// 分类列表
class CategoryFollowItemWidget extends StatefulWidget {
  final String type;
  final String title;
  CategoryFollowItemWidget({Key key, this.type,this.title}) : super(key: key);

  @override
  State<StatefulWidget> createState() => CategoryFollowItemWidgetState();
}

class CategoryFollowItemWidgetState extends State<CategoryFollowItemWidget> {
