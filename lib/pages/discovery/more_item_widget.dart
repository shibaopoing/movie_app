...
class MoreItemWidget extends StatefulWidget {
  final String type;
  final String title;
  MoreItemWidget({Key key, this.type,this.title}) : super(key: key);

  @override
  State<StatefulWidget> createState() => MoreItemWidgetState();
}

class MoreItemWidgetState extends State<MoreItemWidget> {
