...
import 'package:movie_app/pages/video/video_details_model.dart';
...
class VideoDetailsPageState extends State<VideoDetailsPage>
  ...
  @override
  void initState() {
    item = MovieInfo.fromJson(FluroConvertUtils.string2map(widget.itemJson));
    super.initState();
    WidgetsBinding.instance.addObserver(this);
   // getVideoUrl();
    videoUrl = "https://163.com-www-letv.com/20180517/734_5ef2ffc1/index.m3u8";
