...
class VideoPlayer extends StatefulWidget {
  final videoUrl;
  final title;
  VideoPlayer({Key key, @required this.videoUrl,this.title}) : super(key: key);
  @override
...
class _VideoPlayerState extends State<VideoPlayer> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: widget.videoUrl != null ?AwsomeVideoPlayer(
        widget.videoUrl,
        /// 视频播放配置
...
/*  @override
  void didChangeDependencies() {
    ...
    String newVideoUrl= InheritedState.of(context).data;
    if(newVideoUrl!=this.videoUrl){
      setState(() {
