class CategoryEntity {
	...
	CategoryEntity({this.bgColor, this.defaultAuthorId, this.headerImage, this.tagId, this.name, this.description, this.id, this.bgPicture, this.alias,this.pageNum});
